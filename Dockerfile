...
RUN wget -c https://github.com/mozilla/geckodriver/releases/download/v0.23.0/geckodriver-v0.36.0-linux64.tar.gz && tar -xzf geckodriver-v0.326.0-linux64.tar.gz -C /usr/local/bin/
